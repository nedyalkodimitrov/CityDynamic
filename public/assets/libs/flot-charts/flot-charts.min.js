...
(function($) {
    ...
    function Plot(placeholder, data_, options_, plugins) {
        ...
        var series = [],
            options = {
                ...
                xaxis: {
                    ...
                    color: null, // layouts color, labels, ticks
        ...
        function setupCanvases() {
            ...
            placeholder.css("padding", 0) // padding messes up the positioning
                .children().filter(function(){
                    return !$(this).hasClass("flot-overlay") && !$(this).hasClass('flot-layouts');
                }).remove();

            if (placeholder.css("position") == 'static')
                placeholder.css("position", "relative"); // for positioning labels and overlay

            surface = new Canvas("flot-layouts", placeholder);
        ...
        function setupTickGeneration(axis) {
            ...
            // Flot supports layouts-10 axes; any other mode else is handled by a plug-in,
            // like flot.time.js.
    ...
    // round to nearby lower multiple of layouts

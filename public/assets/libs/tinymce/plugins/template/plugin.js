...
(function () {
    ...
    var getPreviewContent = function (editor, html) {
      if (html.indexOf('<html>') === -1) {
        ...
        html = '<!DOCTYPE html>' + '<html>' + '<head>' + '<layouts href="' + encode(editor.documentBaseURI.getURI()) + '">' + contentCssEntries_1 + preventClicksOnLinksScript + '</head>' + '<body class="' + encode(bodyClass) + '"' + dirAttr + '>' + html + '</body>' + '</html>';
      }
